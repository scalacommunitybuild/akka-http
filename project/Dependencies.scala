...
object Dependencies {
  ...
  val Versions = Seq(
    ...
    scalaCheckVersion := System.getProperty("akka.build.scalaCheckVersion", "1.15.1"),
  ...
  object Compile {
    ...
    object Test {
      ...
      val scalatestplusScalacheck = "org.scalatestplus" %% "scalacheck-1-15" % "3.2.9.0" % "test"
      val scalatestplusJUnit      = "org.scalatestplus" %% "junit-4-13"      % "3.2.9.0" % "test"
